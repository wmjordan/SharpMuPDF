...
def main():
	...
	misc_exports = collectFunctions("source/fitz/test-device.c") + ["fz_set_stderr", "fz_set_stdout", "fz_colorspace_name_process_colorants", "fz_getoptw", "fz_valgrind_pixmap", "fz_stderr", "track_usage", "fz_log_errorFL", "fz_log_error_printfFL", "fz_morph_errorFL", "fz_do_catchFL", "fz_rethrowFL", "fz_rethrow_ifFL", "fz_rethrow_unlessFL", "fz_throwFL", "fz_vlog_error_printfFL", "fz_hb_lock", "fz_hb_unlock", "fz_vthrowFL", "fz_vwarnFL", "fz_warnFL", "binary_hyph_all_zip", "binary_hyph_all_zip_size", "HEAP_CAT"]
